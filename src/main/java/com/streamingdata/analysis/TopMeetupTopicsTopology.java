...
public class TopMeetupTopicsTopology {
    ...
    private StormTopology buildTopology() {
        ...
        topologyBuilder.setSpout("kafka_spout",
                new KafkaSpout<>(getKafkaSpoutConfig()), 1);
        topologyBuilder.setBolt("rsvpSummarizer", new MeetupRSVPSummaryBolt(),
                1).globalGrouping("kafka_spout", STREAM_NAME);
        topologyBuilder.setBolt("summarySerializer",
                new KafkaBolt(), 1).shuffleGrouping("rsvpSummarizer");
    ...
    /**
     * Submits (runs) the topology locally.
     *
     * @throws Exception
     */
    public static void main(String[] args) throws Exception {
        new TopMeetupTopicsTopology().runLocally();
    }
}
